...
class SyncManager:
    ...
    def __init__(self, qb_session, qb_url: str, jellyfin_manager, notification_callback=None):
        ...
        Args:
            ...
            notification_callback: Função para enviar notificações (ex: send_telegram)
        """
    ...
    def _handle_completed_torrent(self, torrent_hash: str, name: str, save_path: str):
        """Processa um torrent que acabou de ser concluído"""
    ...
    def _process_queue(self):
        """Processa a fila de torrents concluídos"""
