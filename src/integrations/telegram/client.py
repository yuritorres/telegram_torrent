...
def set_bot_commands() -> None:
    commands = [
        ...
        {"command": "instances", "description": "Listar instâncias qBittorrent"},
        {"command": "torrents_multi", "description": "Torrents de todas instâncias"},
        {"command": "refresh_storage", "description": "Atualizar espaço das instâncias"},
        {"command": "reconnect_instances", "description": "Reconectar instâncias"},
